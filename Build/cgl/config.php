...
// 2. Custom stefanfroemken Overrides
$stefanfroemkenRules = [
    'braces_position' => [
...
// Merge rules: stefanfroemkenRules will overwrite typo3Rules in case of conflicts
$mergedRules = array_merge($typo3Rules, $stefanfroemkenRules);
